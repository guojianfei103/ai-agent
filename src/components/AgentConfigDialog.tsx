...
export function AgentConfigDialog({ 
  ...
  const customAgents = agents.filter(a => a.id !== '__default__');
          ...
          <Card bordered className="p-4">
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                {/* 名称 */}
                <div>
                  <label className="block text-sm font-medium mb-1" style={{ color: 'var(--td-text-color-primary)' }}>
                  ...
                  <input
                    ...
                    placeholder="例如：代码助手"
                    className="w-full px-3 py-2 rounded-lg text-sm border outline-none focus:border-blue-400 transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-3 py-2 rounded-lg text-sm border outline-none focus:border-blue-400 transition-colors resize-y"
                    style={{ border: '1px solid var(--td-component-border)', backgroundColor: 'var(--td-bg-color-container)' }}
                  />
                </div>
              </div>
